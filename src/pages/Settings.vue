<template>
  ...
  >
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" :action="passwordConfig.action" method="POST">
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div v-for="message in passwordConfig.messages" :key="message" class="text-red-500">
            {{ message.text }}
          </div>
        </div>
      ...
      <form class="mt-8 space-y-6" :action="profileConfig.action" method="POST">
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div v-for="message in profileConfig.messages" :key="message" class="text-red-500">
            {{ message.text }}
          </div>
        </div>
